  ...
  //para resaltar los texto de todo contenido de java
  jQuery.fn.extend({
    resaltar: function(busqueda, claseCSSbusqueda){
        ///([-.*+?^${}()|[\]\/\\])/g para caracteres enpeciales dentro de la texto
        //RegExp busca datos de un contenedor 
...
//devuelve el metodo que emos buscado en la funcion
function resaltarTexto(){
    //poner color a las palabras reservadas de java, segun el editor de Visual Studio Code
    var textosA_Resaltar=["class","public","static","import","package","null"];
    for(var i=0;i<textosA_Resaltar.length;i++){
            $(".texto").resaltar(textosA_Resaltar[i], "resaltarTexto");
    }   
}//fin de la funcion 
